...
static const CGFloat kCellHorizontalMargin = 5;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
  ...
  if (self) {
    ...
    [_backgroundView setBackgroundColor:[[UIColor grayBackgroudColor] colorWithAlphaComponent:0.6]];
